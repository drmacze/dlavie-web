(() => {
  ...
  function ensureFlowStyles() {
    ...
    style.textContent = `
      ...
      .pcf-eyebrow{font-size:10px;letter-spacing:.11em;color:#777;font-weight:700;text-transform:uppercase;margin-bottom:4px}.pcf-title{margin:0;font-size:21px;line-height:1.2;font-weight:750}.pcf-message{margin:0 0 5px;color:#aaa;font-size:13px;line-height:1.55}.pcf-detail{margin:0;color:#666;font-size:11px;line-height:1.5}
      .pcf-steps{margin:20px 0;padding:14px;border-radius:18px;background:#090a0a;border:1px solid rgba(255,255,255,.07);display:grid;gap:12px}.pcf-step{display:flex;align-items:center;gap:10px}.pcf-step-dot{width:26px;height:26px;border-radius:50%;border:1px solid rgba(255,255,255,.1);display:grid;place-items:center;font-size:10px;font-weight:800;color:#555;flex:none}.pcf-step.active .pcf-step-dot{color:#fff;background:rgba(255,255,255,.09);border-color:rgba(255,255,255,.28)}.pcf-step.done .pcf-step-dot{color:#35d07f;background:rgba(53,208,127,.12);border-color:rgba(53,208,127,.32)}.pcf-step-copy strong{display:block;font-size:12px;color:#666}.pcf-step-copy span{display:block;font-size:10px;color:#444;margin-top:2px}.pcf-step.active .pcf-step-copy strong,.pcf-step.done .pcf-step-copy strong{color:#eee}.pcf-step.active .pcf-step-copy span,.pcf-step.done .pcf-step-copy span{color:#777}
      ...
      .pcf-actions{display:grid;gap:9px}.pcf-primary,.pcf-secondary{width:100%;height:50px;border-radius:14px;font:700 13px 'Space Grotesk',system-ui,sans-serif;cursor:pointer}.pcf-primary{border:0;background:#fff;color:#050505}.pcf-primary:disabled{opacity:.45;cursor:not-allowed}.pcf-secondary{border:1px solid rgba(255,255,255,.12);background:transparent;color:#aaa}.pcf-security{margin:16px 0 0;text-align:center;color:#555;font-size:10px;line-height:1.5}
      .pcf-notice{position:fixed;z-index:9998;left:16px;right:16px;top:max(16px,env(safe-area-inset-top));margin:auto;width:min(560px,calc(100% - 32px));padding:14px 15px;border-radius:16px;background:rgba(16,17,17,.97);border:1px solid rgba(255,255,255,.11);box-shadow:0 14px 50px rgba(0,0,0,.52);display:flex;align-items:flex-start;gap:11px;color:#fff;font-family:'Space Grotesk',system-ui,sans-serif}.pcf-notice-dot{width:8px;height:8px;border-radius:50%;background:#fff;margin-top:5px;flex:none}.pcf-notice-copy{flex:1}.pcf-notice-copy strong{display:block;font-size:12px}.pcf-notice-copy span{display:block;color:#888;font-size:11px;line-height:1.45;margin-top:3px}.pcf-notice button{border:0;background:transparent;color:#777;font-size:18px;line-height:1;cursor:pointer;padding:0 2px}
